...
void OHltTree::Init(TTree *tree)
{
  ...
  fChain->SetBranchAddress("L1Tech_CASTOR_HaloMuon.v0", &map_BitOfStandardHLTPath["L1Tech_CASTOR_HaloMuon.v0"], &b_L1Tech_CASTOR_HaloMuonv0);
  fChain->SetBranchAddress("L1Tech_CASTOR_MediumJet.v0", &map_BitOfStandardHLTPath["L1Tech_CASTOR_MediumJet.v0"], &b_L1Tech_CASTOR_MediumJetv0);
  fChain->SetBranchAddress("L1Tech_CASTOR_HighJet.v0", &map_BitOfStandardHLTPath["L1Tech_CASTOR_HighJet.v0"], &b_L1Tech_CASTOR_HighJetv0);
  fChain->SetBranchAddress("L1Tech_CASTOR_Gap.v0", &map_BitOfStandardHLTPath["L1Tech_CASTOR_Gap.v0"], &b_L1Tech_CASTOR_Gapv0);
  fChain->SetBranchAddress("L1Tech_TOTEM_3", &map_BitOfStandardHLTPath["L1Tech_TOTEM_3"], &b_L1Tech_TOTEM_3);
  fChain->SetBranchAddress("L1Tech_TOTEM_2", &map_BitOfStandardHLTPath["L1Tech_TOTEM_2"], &b_L1Tech_TOTEM_2);
  fChain->SetBranchAddress("L1Tech_TOTEM_1", &map_BitOfStandardHLTPath["L1Tech_TOTEM_1"], &b_L1Tech_TOTEM_1);
  fChain->SetBranchAddress("L1Tech_TOTEM_0", &map_BitOfStandardHLTPath["L1Tech_TOTEM_0"], &b_L1Tech_TOTEM_0);
  fChain->SetBranchAddress("L1Tech__TTU_RB0_Cosmics.v0", &map_BitOfStandardHLTPath["L1Tech__TTU_RB0_Cosmics.v0"], &b_L1Tech__TTU_RB0_Cosmicsv0);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_RBplus1_Cosmics.v0", &map_BitOfStandardHLTPath["L1Tech_RPC_TTU_RBplus1_Cosmics.v0"], &b_L1Tech_RPC_TTU_RBplus1_Cosmicsv0);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_RBplus2_Cosmics.v0", &map_BitOfStandardHLTPath["L1Tech_RPC_TTU_RBplus2_Cosmics.v0"], &b_L1Tech_RPC_TTU_RBplus2_Cosmicsv0);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_pointing_Cosmics.v0", &map_BitOfStandardHLTPath["L1Tech_RPC_TTU_pointing_Cosmics.v0"], &b_L1Tech_RPC_TTU_pointing_Cosmicsv0);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_barrel_Cosmics.v0", &map_BitOfStandardHLTPath["L1Tech_RPC_TTU_barrel_Cosmics.v0"], &b_L1Tech_RPC_TTU_barrel_Cosmicsv0);
  fChain->SetBranchAddress("L1Tech_DT_GlobalOR.v0", &map_BitOfStandardHLTPath["L1Tech_DT_GlobalOR.v0"], &b_L1Tech_DT_GlobalORv0);
  fChain->SetBranchAddress("L1Tech_BPTX_PreBPTX.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_PreBPTX.v0"], &b_L1Tech_BPTX_PreBPTXv0);
  fChain->SetBranchAddress("L1Tech_HCAL_HBHE_totalOR.v0", &map_BitOfStandardHLTPath["L1Tech_HCAL_HBHE_totalOR.v0"], &b_L1Tech_HCAL_HBHE_totalORv0);
  fChain->SetBranchAddress("L1Tech_HCAL_HO_totalOR.v0", &map_BitOfStandardHLTPath["L1Tech_HCAL_HO_totalOR.v0"], &b_L1Tech_HCAL_HO_totalORv0);
  fChain->SetBranchAddress("L1Tech_HCAL_HF_MMP_or_MPP.v1", &map_BitOfStandardHLTPath["L1Tech_HCAL_HF_MMP_or_MPP.v1"], &b_L1Tech_HCAL_HF_MMP_or_MPPv1);
  fChain->SetBranchAddress("L1Tech_HCAL_HF_coincidence_PM.v2", &map_BitOfStandardHLTPath["L1Tech_HCAL_HF_coincidence_PM.v2"], &b_L1Tech_HCAL_HF_coincidence_PMv2);
  fChain->SetBranchAddress("L1Tech_HCAL_HF_single_channel.v0", &map_BitOfStandardHLTPath["L1Tech_HCAL_HF_single_channel.v0"], &b_L1Tech_HCAL_HF_single_channelv0);
  fChain->SetBranchAddress("L1Tech_BPTX_quiet.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_quiet.v0"], &b_L1Tech_BPTX_quietv0);
  fChain->SetBranchAddress("L1Tech_BPTX_minus_AND_not_plus.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_minus_AND_not_plus.v0"], &b_L1Tech_BPTX_minus_AND_not_plusv0);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_AND_NOT_minus.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_plus_AND_NOT_minus.v0"], &b_L1Tech_BPTX_plus_AND_NOT_minusv0);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_AND_minus_instance1.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_plus_AND_minus_instance1.v0"], &b_L1Tech_BPTX_plus_AND_minus_instance1v0);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_OR_minus.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_plus_OR_minus.v0"], &b_L1Tech_BPTX_plus_OR_minusv0);
  fChain->SetBranchAddress("L1Tech_BPTX_minus.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_minus.v0"], &b_L1Tech_BPTX_minusv0);
  fChain->SetBranchAddress("L1Tech_BPTX_plus.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_plus.v0"], &b_L1Tech_BPTX_plusv0);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_AND_minus.v0", &map_BitOfStandardHLTPath["L1Tech_BPTX_plus_AND_minus.v0"], &b_L1Tech_BPTX_plus_AND_minusv0);
  fChain->SetBranchAddress("L1_SingleMuBeamHalo", &map_BitOfStandardHLTPath["L1_SingleMuBeamHalo"], &b_L1_SingleMuBeamHalo);
  fChain->SetBranchAddress("L1_DoubleMu_10_0_WdEta18", &map_BitOfStandardHLTPath["L1_DoubleMu_10_0_WdEta18"], &b_L1_DoubleMu_10_0_WdEta18);
  fChain->SetBranchAddress("L1_DoubleMu_12_5", &map_BitOfStandardHLTPath["L1_DoubleMu_12_5"], &b_L1_DoubleMu_12_5);
  fChain->SetBranchAddress("L1_DoubleMu0_Eta1p6_WdEta18_OS", &map_BitOfStandardHLTPath["L1_DoubleMu0_Eta1p6_WdEta18_OS"], &b_L1_DoubleMu0_Eta1p6_WdEta18_OS);
  fChain->SetBranchAddress("L1_SingleMu18er", &map_BitOfStandardHLTPath["L1_SingleMu18er"], &b_L1_SingleMu18er);
  fChain->SetBranchAddress("L1_QuadMu0", &map_BitOfStandardHLTPath["L1_QuadMu0"], &b_L1_QuadMu0);
  fChain->SetBranchAddress("L1_TripleJet_92_76_64", &map_BitOfStandardHLTPath["L1_TripleJet_92_76_64"], &b_L1_TripleJet_92_76_64);
  fChain->SetBranchAddress("L1_RomanPotsAND", &map_BitOfStandardHLTPath["L1_RomanPotsAND"], &b_L1_RomanPotsAND);
  fChain->SetBranchAddress("L1_ETT130", &map_BitOfStandardHLTPath["L1_ETT130"], &b_L1_ETT130);
  fChain->SetBranchAddress("L1_ETM70_NotJet52WdPhi2", &map_BitOfStandardHLTPath["L1_ETM70_NotJet52WdPhi2"], &b_L1_ETM70_NotJet52WdPhi2);
  fChain->SetBranchAddress("L1_ETM60_NotJet52WdPhi2", &map_BitOfStandardHLTPath["L1_ETM60_NotJet52WdPhi2"], &b_L1_ETM60_NotJet52WdPhi2);
  fChain->SetBranchAddress("L1_DoubleMu0_Eta1p6_WdEta18", &map_BitOfStandardHLTPath["L1_DoubleMu0_Eta1p6_WdEta18"], &b_L1_DoubleMu0_Eta1p6_WdEta18);
  fChain->SetBranchAddress("L1_DoubleJetC56_ETM60", &map_BitOfStandardHLTPath["L1_DoubleJetC56_ETM60"], &b_L1_DoubleJetC56_ETM60);
  ...
  fChain->SetBranchAddress("L1_QuadJetC60", &map_BitOfStandardHLTPath["L1_QuadJetC60"], &b_L1_QuadJetC60);
  fChain->SetBranchAddress("L1_DoubleJetC100", &map_BitOfStandardHLTPath["L1_DoubleJetC100"], &b_L1_DoubleJetC100);
  fChain->SetBranchAddress("L1_ETM60", &map_BitOfStandardHLTPath["L1_ETM60"], &b_L1_ETM60);
  fChain->SetBranchAddress("L1_Jet32_MuOpen_EG10_MuEGNotWdPhi3_JetMuWdPhi1", &map_BitOfStandardHLTPath["L1_Jet32_MuOpen_EG10_MuEGNotWdPhi3_JetMuWdPhi1"], &b_L1_Jet32_MuOpen_EG10_MuEGNotWdPhi3_JetMuWdPhi1);
  fChain->SetBranchAddress("L1_Jet32_DoubleMu_Open_10_MuMuNotWdPhi23_JetMuWdPhi1", &map_BitOfStandardHLTPath["L1_Jet32_DoubleMu_Open_10_MuMuNotWdPhi23_JetMuWdPhi1"], &b_L1_Jet32_DoubleMu_Open_10_MuMuNotWdPhi23_JetMuWdPhi1);
  fChain->SetBranchAddress("L1_DoubleJetC32_WdPhi7_HTT125", &map_BitOfStandardHLTPath["L1_DoubleJetC32_WdPhi7_HTT125"], &b_L1_DoubleJetC32_WdPhi7_HTT125);
  fChain->SetBranchAddress("L1_DoubleJetC60_ETM60", &map_BitOfStandardHLTPath["L1_DoubleJetC60_ETM60"], &b_L1_DoubleJetC60_ETM60);
  fChain->SetBranchAddress("L1_Mu0er_ETM55", &map_BitOfStandardHLTPath["L1_Mu0er_ETM55"], &b_L1_Mu0er_ETM55);
  fChain->SetBranchAddress("L1_DoubleEG_20_10_1LegIso", &map_BitOfStandardHLTPath["L1_DoubleEG_20_10_1LegIso"], &b_L1_DoubleEG_20_10_1LegIso);
  fChain->SetBranchAddress("L1_DoubleEG_22_10", &map_BitOfStandardHLTPath["L1_DoubleEG_22_10"], &b_L1_DoubleEG_22_10);
  fChain->SetBranchAddress("L1_DoubleEG_15_10", &map_BitOfStandardHLTPath["L1_DoubleEG_15_10"], &b_L1_DoubleEG_15_10);
  fChain->SetBranchAddress("L1_TripleEG_14_10_8", &map_BitOfStandardHLTPath["L1_TripleEG_14_10_8"], &b_L1_TripleEG_14_10_8);
  fChain->SetBranchAddress("L1_SingleJet12", &map_BitOfStandardHLTPath["L1_SingleJet12"], &b_L1_SingleJet12);
  fChain->SetBranchAddress("L1_TripleMu_5_5_3", &map_BitOfStandardHLTPath["L1_TripleMu_5_5_3"], &b_L1_TripleMu_5_5_3);
  ...
  fChain->SetBranchAddress("L1_ETT90", &map_BitOfStandardHLTPath["L1_ETT90"], &b_L1_ETT90);
  fChain->SetBranchAddress("L1_ETT60", &map_BitOfStandardHLTPath["L1_ETT60"], &b_L1_ETT60);
  fChain->SetBranchAddress("L1_QuadJetC36_TauJet52", &map_BitOfStandardHLTPath["L1_QuadJetC36_TauJet52"], &b_L1_QuadJetC36_TauJet52);
  fChain->SetBranchAddress("L1_DoubleEG6_HTT150", &map_BitOfStandardHLTPath["L1_DoubleEG6_HTT150"], &b_L1_DoubleEG6_HTT150);
  fChain->SetBranchAddress("L1_Mu5_DoubleEG5", &map_BitOfStandardHLTPath["L1_Mu5_DoubleEG5"], &b_L1_Mu5_DoubleEG5);
  fChain->SetBranchAddress("L1_DoubleMu6_EG6", &map_BitOfStandardHLTPath["L1_DoubleMu6_EG6"], &b_L1_DoubleMu6_EG6);
  fChain->SetBranchAddress("L1_SingleMuOpen_NotBptxOR", &map_BitOfStandardHLTPath["L1_SingleMuOpen_NotBptxOR"], &b_L1_SingleMuOpen_NotBptxOR);
  fChain->SetBranchAddress("L1_Mu4_EG18", &map_BitOfStandardHLTPath["L1_Mu4_EG18"], &b_L1_Mu4_EG18);
  fChain->SetBranchAddress("L1_Mu8_HTT125", &map_BitOfStandardHLTPath["L1_Mu8_HTT125"], &b_L1_Mu8_HTT125);
  fChain->SetBranchAddress("L1_SingleMu16_Eta2p1", &map_BitOfStandardHLTPath["L1_SingleMu16_Eta2p1"], &b_L1_SingleMu16_Eta2p1);
  fChain->SetBranchAddress("L1_DoubleMu7_EG7", &map_BitOfStandardHLTPath["L1_DoubleMu7_EG7"], &b_L1_DoubleMu7_EG7);
  fChain->SetBranchAddress("L1_Mu14er_ETM30", &map_BitOfStandardHLTPath["L1_Mu14er_ETM30"], &b_L1_Mu14er_ETM30);
  fChain->SetBranchAddress("L1_Mu10er_ETM50", &map_BitOfStandardHLTPath["L1_Mu10er_ETM50"], &b_L1_Mu10er_ETM50);
  fChain->SetBranchAddress("L1_Mu6_HTT150", &map_BitOfStandardHLTPath["L1_Mu6_HTT150"], &b_L1_Mu6_HTT150);
  fChain->SetBranchAddress("L1_Mu20_EG8", &map_BitOfStandardHLTPath["L1_Mu20_EG8"], &b_L1_Mu20_EG8);
  ...
  fChain->SetBranchAddress("L1_Mu6_DoubleEG10", &map_BitOfStandardHLTPath["L1_Mu6_DoubleEG10"], &b_L1_Mu6_DoubleEG10);
  fChain->SetBranchAddress("L1_Mu5_IsoEG18", &map_BitOfStandardHLTPath["L1_Mu5_IsoEG18"], &b_L1_Mu5_IsoEG18);
  fChain->SetBranchAddress("L1_Mu5_EG20", &map_BitOfStandardHLTPath["L1_Mu5_EG20"], &b_L1_Mu5_EG20);
  fChain->SetBranchAddress("L1_Mu20_EG10", &map_BitOfStandardHLTPath["L1_Mu20_EG10"], &b_L1_Mu20_EG10);
  ...
  fChain->SetBranchAddress("L1_SingleMu30", &map_BitOfStandardHLTPath["L1_SingleMu30"], &b_L1_SingleMu30);
  ...
  fChain->SetBranchAddress("L1_ETT40", &map_BitOfStandardHLTPath["L1_ETT40"], &b_L1_ETT40);
  ...
  fChain->SetBranchAddress("L1_SingleEG35", &map_BitOfStandardHLTPath["L1_SingleEG35"], &b_L1_SingleEG35);
  ...
  fChain->SetBranchAddress("L1_SingleIsoEG18", &map_BitOfStandardHLTPath["L1_SingleIsoEG18"], &b_L1_SingleIsoEG18);
  fChain->SetBranchAddress("L1_SingleEG40", &map_BitOfStandardHLTPath["L1_SingleEG40"], &b_L1_SingleEG40);
  ...
  fChain->SetBranchAddress("L1_DoubleJetC112", &map_BitOfStandardHLTPath["L1_DoubleJetC112"], &b_L1_DoubleJetC112);
  fChain->SetBranchAddress("L1_SingleMu14_Eta2p1", &map_BitOfStandardHLTPath["L1_SingleMu14_Eta2p1"], &b_L1_SingleMu14_Eta2p1);
  fChain->SetBranchAddress("L1_DoubleJetC84", &map_BitOfStandardHLTPath["L1_DoubleJetC84"], &b_L1_DoubleJetC84);
  fChain->SetBranchAddress("L1_DoubleJetC52", &map_BitOfStandardHLTPath["L1_DoubleJetC52"], &b_L1_DoubleJetC52);
  fChain->SetBranchAddress("L1_SingleJet240", &map_BitOfStandardHLTPath["L1_SingleJet240"], &b_L1_SingleJet240);
  fChain->SetBranchAddress("L1_SingleIsoEG22er", &map_BitOfStandardHLTPath["L1_SingleIsoEG22er"], &b_L1_SingleIsoEG22er);
  fChain->SetBranchAddress("L1_SingleEG10", &map_BitOfStandardHLTPath["L1_SingleEG10"], &b_L1_SingleEG10);
  fChain->SetBranchAddress("L1_SingleIsoEG30er", &map_BitOfStandardHLTPath["L1_SingleIsoEG30er"], &b_L1_SingleIsoEG30er);
  fChain->SetBranchAddress("L1_SingleIsoEG28er", &map_BitOfStandardHLTPath["L1_SingleIsoEG28er"], &b_L1_SingleIsoEG28er);
  fChain->SetBranchAddress("L1_SingleIsoEG25", &map_BitOfStandardHLTPath["L1_SingleIsoEG25"], &b_L1_SingleIsoEG25);
  fChain->SetBranchAddress("L1_SingleIsoEG25er", &map_BitOfStandardHLTPath["L1_SingleIsoEG25er"], &b_L1_SingleIsoEG25er);
  fChain->SetBranchAddress("L1_SingleEG35er", &map_BitOfStandardHLTPath["L1_SingleEG35er"], &b_L1_SingleEG35er);
  fChain->SetBranchAddress("L1_EG25er_HTT125", &map_BitOfStandardHLTPath["L1_EG25er_HTT125"], &b_L1_EG25er_HTT125);
  ...
  fChain->SetBranchAddress("L1_ETT15", &map_BitOfStandardHLTPath["L1_ETT15"], &b_L1_ETT15);
  fChain->SetBranchAddress("L1_SingleMu30er", &map_BitOfStandardHLTPath["L1_SingleMu30er"], &b_L1_SingleMu30er);
  ...
  fChain->SetBranchAddress("L1_DoubleTauJet36er", &map_BitOfStandardHLTPath["L1_DoubleTauJet36er"], &b_L1_DoubleTauJet36er);
  ...
  fChain->SetBranchAddress("L1_SingleJet176", &map_BitOfStandardHLTPath["L1_SingleJet176"], &b_L1_SingleJet176);
  ...
  fChain->SetBranchAddress("L1_DoubleJetC120", &map_BitOfStandardHLTPath["L1_DoubleJetC120"], &b_L1_DoubleJetC120);
  fChain->SetBranchAddress("L1_DoubleJetC72", &map_BitOfStandardHLTPath["L1_DoubleJetC72"], &b_L1_DoubleJetC72);
  fChain->SetBranchAddress("L1_QuadJetC84", &map_BitOfStandardHLTPath["L1_QuadJetC84"], &b_L1_QuadJetC84);
  fChain->SetBranchAddress("L1_Mu16er_TauJet20er", &map_BitOfStandardHLTPath["L1_Mu16er_TauJet20er"], &b_L1_Mu16er_TauJet20er);
  fChain->SetBranchAddress("L1_IsoEG20er_TauJet20er_NotWdEta0", &map_BitOfStandardHLTPath["L1_IsoEG20er_TauJet20er_NotWdEta0"], &b_L1_IsoEG20er_TauJet20er_NotWdEta0);
  fChain->SetBranchAddress("L1_DoubleTauJet40er", &map_BitOfStandardHLTPath["L1_DoubleTauJet40er"], &b_L1_DoubleTauJet40er);
  fChain->SetBranchAddress("L1_Mu5_EG15", &map_BitOfStandardHLTPath["L1_Mu5_EG15"], &b_L1_Mu5_EG15);
  fChain->SetBranchAddress("L1_Mu12_EG10", &map_BitOfStandardHLTPath["L1_Mu12_EG10"], &b_L1_Mu12_EG10);
  fChain->SetBranchAddress("L1_Mu16er_TauJet40erORCenJet72er", &map_BitOfStandardHLTPath["L1_Mu16er_TauJet40erORCenJet72er"], &b_L1_Mu16er_TauJet40erORCenJet72er);
  fChain->SetBranchAddress("L1_MinimumBiasHF2_OR", &map_BitOfStandardHLTPath["L1_MinimumBiasHF2_OR"], &b_L1_MinimumBiasHF2_OR);
  fChain->SetBranchAddress("L1_MinimumBiasHF2_AND", &map_BitOfStandardHLTPath["L1_MinimumBiasHF2_AND"], &b_L1_MinimumBiasHF2_AND);
  fChain->SetBranchAddress("L1_MinimumBiasHF1_OR", &map_BitOfStandardHLTPath["L1_MinimumBiasHF1_OR"], &b_L1_MinimumBiasHF1_OR);
  fChain->SetBranchAddress("L1_MinimumBiasHF1_AND_v1", &map_BitOfStandardHLTPath["L1_MinimumBiasHF1_AND_v1"], &b_L1_MinimumBiasHF1_AND_v1);
  ...
  fChain->SetBranchAddress("L1_AlwaysTrue", &map_BitOfStandardHLTPath["L1_AlwaysTrue"], &b_L1_AlwaysTrue);
  ...
  fChain->SetBranchAddress("L1Tech_CASTOR_HaloMuon.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_CASTOR_HaloMuon.v0"], &b_L1Tech_CASTOR_HaloMuonv0_Prescl);
  fChain->SetBranchAddress("L1Tech_CASTOR_MediumJet.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_CASTOR_MediumJet.v0"], &b_L1Tech_CASTOR_MediumJetv0_Prescl);
  fChain->SetBranchAddress("L1Tech_CASTOR_HighJet.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_CASTOR_HighJet.v0"], &b_L1Tech_CASTOR_HighJetv0_Prescl);
  fChain->SetBranchAddress("L1Tech_CASTOR_Gap.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_CASTOR_Gap.v0"], &b_L1Tech_CASTOR_Gapv0_Prescl);
  fChain->SetBranchAddress("L1Tech_TOTEM_3_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_TOTEM_3"], &b_L1Tech_TOTEM_3_Prescl);
  fChain->SetBranchAddress("L1Tech_TOTEM_2_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_TOTEM_2"], &b_L1Tech_TOTEM_2_Prescl);
  fChain->SetBranchAddress("L1Tech_TOTEM_1_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_TOTEM_1"], &b_L1Tech_TOTEM_1_Prescl);
  fChain->SetBranchAddress("L1Tech_TOTEM_0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_TOTEM_0"], &b_L1Tech_TOTEM_0_Prescl);
  fChain->SetBranchAddress("L1Tech__TTU_RB0_Cosmics.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech__TTU_RB0_Cosmics.v0"], &b_L1Tech__TTU_RB0_Cosmicsv0_Prescl);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_RBplus1_Cosmics.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_RPC_TTU_RBplus1_Cosmics.v0"], &b_L1Tech_RPC_TTU_RBplus1_Cosmicsv0_Prescl);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_RBplus2_Cosmics.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_RPC_TTU_RBplus2_Cosmics.v0"], &b_L1Tech_RPC_TTU_RBplus2_Cosmicsv0_Prescl);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_pointing_Cosmics.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_RPC_TTU_pointing_Cosmics.v0"], &b_L1Tech_RPC_TTU_pointing_Cosmicsv0_Prescl);
  fChain->SetBranchAddress("L1Tech_RPC_TTU_barrel_Cosmics.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_RPC_TTU_barrel_Cosmics.v0"], &b_L1Tech_RPC_TTU_barrel_Cosmicsv0_Prescl);
  fChain->SetBranchAddress("L1Tech_DT_GlobalOR.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_DT_GlobalOR.v0"], &b_L1Tech_DT_GlobalORv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_PreBPTX.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_PreBPTX.v0"], &b_L1Tech_BPTX_PreBPTXv0_Prescl);
  fChain->SetBranchAddress("L1Tech_HCAL_HBHE_totalOR.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_HCAL_HBHE_totalOR.v0"], &b_L1Tech_HCAL_HBHE_totalORv0_Prescl);
  fChain->SetBranchAddress("L1Tech_HCAL_HO_totalOR.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_HCAL_HO_totalOR.v0"], &b_L1Tech_HCAL_HO_totalORv0_Prescl);
  fChain->SetBranchAddress("L1Tech_HCAL_HF_MMP_or_MPP.v1_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_HCAL_HF_MMP_or_MPP.v1"], &b_L1Tech_HCAL_HF_MMP_or_MPPv1_Prescl);
  fChain->SetBranchAddress("L1Tech_HCAL_HF_coincidence_PM.v2_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_HCAL_HF_coincidence_PM.v2"], &b_L1Tech_HCAL_HF_coincidence_PMv2_Prescl);
  fChain->SetBranchAddress("L1Tech_HCAL_HF_single_channel.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_HCAL_HF_single_channel.v0"], &b_L1Tech_HCAL_HF_single_channelv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_quiet.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_quiet.v0"], &b_L1Tech_BPTX_quietv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_minus_AND_not_plus.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_minus_AND_not_plus.v0"], &b_L1Tech_BPTX_minus_AND_not_plusv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_AND_NOT_minus.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_plus_AND_NOT_minus.v0"], &b_L1Tech_BPTX_plus_AND_NOT_minusv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_AND_minus_instance1.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_plus_AND_minus_instance1.v0"], &b_L1Tech_BPTX_plus_AND_minus_instance1v0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_OR_minus.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_plus_OR_minus.v0"], &b_L1Tech_BPTX_plus_OR_minusv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_minus.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_minus.v0"], &b_L1Tech_BPTX_minusv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_plus.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_plus.v0"], &b_L1Tech_BPTX_plusv0_Prescl);
  fChain->SetBranchAddress("L1Tech_BPTX_plus_AND_minus.v0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1Tech_BPTX_plus_AND_minus.v0"], &b_L1Tech_BPTX_plus_AND_minusv0_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleMu_10_0_WdEta18_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleMu_10_0_WdEta18"], &b_L1_DoubleMu_10_0_WdEta18_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleMu0_Eta1p6_WdEta18_OS_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleMu0_Eta1p6_WdEta18_OS"], &b_L1_DoubleMu0_Eta1p6_WdEta18_OS_Prescl);
  fChain->SetBranchAddress("L1_SingleMu18er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleMu18er"], &b_L1_SingleMu18er_Prescl);
  fChain->SetBranchAddress("L1_QuadMu0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_QuadMu0"], &b_L1_QuadMu0_Prescl);
  fChain->SetBranchAddress("L1_TripleJet_92_76_64_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_TripleJet_92_76_64"], &b_L1_TripleJet_92_76_64_Prescl);
  fChain->SetBranchAddress("L1_RomanPotsAND_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_RomanPotsAND"], &b_L1_RomanPotsAND_Prescl);
  fChain->SetBranchAddress("L1_ETT130_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETT130"], &b_L1_ETT130_Prescl);
  fChain->SetBranchAddress("L1_ETM70_NotJet52WdPhi2_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETM70_NotJet52WdPhi2"], &b_L1_ETM70_NotJet52WdPhi2_Prescl);
  fChain->SetBranchAddress("L1_ETM60_NotJet52WdPhi2_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETM60_NotJet52WdPhi2"], &b_L1_ETM60_NotJet52WdPhi2_Prescl);
  fChain->SetBranchAddress("L1_DoubleMu0_Eta1p6_WdEta18_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleMu0_Eta1p6_WdEta18"], &b_L1_DoubleMu0_Eta1p6_WdEta18_Prescl);
  fChain->SetBranchAddress("L1_DoubleJetC56_ETM60_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC56_ETM60"], &b_L1_DoubleJetC56_ETM60_Prescl);
  ...
  fChain->SetBranchAddress("L1_QuadJetC60_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_QuadJetC60"], &b_L1_QuadJetC60_Prescl);
  fChain->SetBranchAddress("L1_DoubleJetC100_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC100"], &b_L1_DoubleJetC100_Prescl);
  fChain->SetBranchAddress("L1_ETM60_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETM60"], &b_L1_ETM60_Prescl);
  fChain->SetBranchAddress("L1_Jet32_MuOpen_EG10_MuEGNotWdPhi3_JetMuWdPhi1_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Jet32_MuOpen_EG10_MuEGNotWdPhi3_JetMuWdPhi1"], &b_L1_Jet32_MuOpen_EG10_MuEGNotWdPhi3_JetMuWdPhi1_Prescl);
  fChain->SetBranchAddress("L1_Jet32_DoubleMu_Open_10_MuMuNotWdPhi23_JetMuWdPhi1_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Jet32_DoubleMu_Open_10_MuMuNotWdPhi23_JetMuWdPhi1"], &b_L1_Jet32_DoubleMu_Open_10_MuMuNotWdPhi23_JetMuWdPhi1_Prescl);
  fChain->SetBranchAddress("L1_DoubleJetC32_WdPhi7_HTT125_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC32_WdPhi7_HTT125"], &b_L1_DoubleJetC32_WdPhi7_HTT125_Prescl);
  fChain->SetBranchAddress("L1_DoubleJetC60_ETM60_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC60_ETM60"], &b_L1_DoubleJetC60_ETM60_Prescl);
  fChain->SetBranchAddress("L1_Mu0er_ETM55_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu0er_ETM55"], &b_L1_Mu0er_ETM55_Prescl);
  fChain->SetBranchAddress("L1_DoubleEG_20_10_1LegIso_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleEG_20_10_1LegIso"], &b_L1_DoubleEG_20_10_1LegIso_Prescl);
  fChain->SetBranchAddress("L1_DoubleEG_22_10_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleEG_22_10"], &b_L1_DoubleEG_22_10_Prescl);
  fChain->SetBranchAddress("L1_DoubleEG_15_10_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleEG_15_10"], &b_L1_DoubleEG_15_10_Prescl);
  fChain->SetBranchAddress("L1_TripleEG_14_10_8_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_TripleEG_14_10_8"], &b_L1_TripleEG_14_10_8_Prescl);
  fChain->SetBranchAddress("L1_SingleJet12_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleJet12"], &b_L1_SingleJet12_Prescl);
  fChain->SetBranchAddress("L1_TripleMu_5_5_3_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_TripleMu_5_5_3"], &b_L1_TripleMu_5_5_3_Prescl);
  ...
  fChain->SetBranchAddress("L1_ETT90_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETT90"], &b_L1_ETT90_Prescl);
  fChain->SetBranchAddress("L1_ETT60_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETT60"], &b_L1_ETT60_Prescl);
  fChain->SetBranchAddress("L1_QuadJetC36_TauJet52_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_QuadJetC36_TauJet52"], &b_L1_QuadJetC36_TauJet52_Prescl);
  fChain->SetBranchAddress("L1_DoubleEG6_HTT150_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleEG6_HTT150"], &b_L1_DoubleEG6_HTT150_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleMu6_EG6_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleMu6_EG6"], &b_L1_DoubleMu6_EG6_Prescl);
  fChain->SetBranchAddress("L1_SingleMuOpen_NotBptxOR_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleMuOpen_NotBptxOR"], &b_L1_SingleMuOpen_NotBptxOR_Prescl);
  fChain->SetBranchAddress("L1_Mu4_EG18_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu4_EG18"], &b_L1_Mu4_EG18_Prescl);
  fChain->SetBranchAddress("L1_Mu8_HTT125_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu8_HTT125"], &b_L1_Mu8_HTT125_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleMu7_EG7_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleMu7_EG7"], &b_L1_DoubleMu7_EG7_Prescl);
  fChain->SetBranchAddress("L1_Mu14er_ETM30_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu14er_ETM30"], &b_L1_Mu14er_ETM30_Prescl);
  fChain->SetBranchAddress("L1_Mu10er_ETM50_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu10er_ETM50"], &b_L1_Mu10er_ETM50_Prescl);
  fChain->SetBranchAddress("L1_Mu6_HTT150_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu6_HTT150"], &b_L1_Mu6_HTT150_Prescl);
  fChain->SetBranchAddress("L1_Mu20_EG8_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu20_EG8"], &b_L1_Mu20_EG8_Prescl);
  fChain->SetBranchAddress("L1_HTT250_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_HTT250"], &b_L1_HTT250_Prescl);
  ...
  fChain->SetBranchAddress("L1_Mu6_DoubleEG10_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu6_DoubleEG10"], &b_L1_Mu6_DoubleEG10_Prescl);
  fChain->SetBranchAddress("L1_Mu5_IsoEG18_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu5_IsoEG18"], &b_L1_Mu5_IsoEG18_Prescl);
  fChain->SetBranchAddress("L1_Mu5_EG20_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu5_EG20"], &b_L1_Mu5_EG20_Prescl);
  fChain->SetBranchAddress("L1_Mu20_EG10_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu20_EG10"], &b_L1_Mu20_EG10_Prescl);
  ...
  fChain->SetBranchAddress("L1_SingleMu30_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleMu30"], &b_L1_SingleMu30_Prescl);
  ...
  fChain->SetBranchAddress("L1_ETT40_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETT40"], &b_L1_ETT40_Prescl);
  ...
  fChain->SetBranchAddress("L1_SingleEG35_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleEG35"], &b_L1_SingleEG35_Prescl);
  ...
  fChain->SetBranchAddress("L1_SingleIsoEG18_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleIsoEG18"], &b_L1_SingleIsoEG18_Prescl);
  fChain->SetBranchAddress("L1_SingleEG40_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleEG40"], &b_L1_SingleEG40_Prescl);
  fChain->SetBranchAddress("L1_SingleEG25_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleEG25"], &b_L1_SingleEG25_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleJetC112_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC112"], &b_L1_DoubleJetC112_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleJetC84_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC84"], &b_L1_DoubleJetC84_Prescl);
  fChain->SetBranchAddress("L1_DoubleJetC52_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC52"], &b_L1_DoubleJetC52_Prescl);
  fChain->SetBranchAddress("L1_SingleJet240_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleJet240"], &b_L1_SingleJet240_Prescl);
  fChain->SetBranchAddress("L1_SingleIsoEG22er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleIsoEG22er"], &b_L1_SingleIsoEG22er_Prescl);
  fChain->SetBranchAddress("L1_SingleEG10_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleEG10"], &b_L1_SingleEG10_Prescl);
  fChain->SetBranchAddress("L1_SingleIsoEG30er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleIsoEG30er"], &b_L1_SingleIsoEG30er_Prescl);
  fChain->SetBranchAddress("L1_SingleIsoEG28er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleIsoEG28er"], &b_L1_SingleIsoEG28er_Prescl);
  fChain->SetBranchAddress("L1_SingleIsoEG25_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleIsoEG25"], &b_L1_SingleIsoEG25_Prescl);
  fChain->SetBranchAddress("L1_SingleIsoEG25er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleIsoEG25er"], &b_L1_SingleIsoEG25er_Prescl);
  fChain->SetBranchAddress("L1_SingleEG35er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleEG35er"], &b_L1_SingleEG35er_Prescl);
  fChain->SetBranchAddress("L1_EG25er_HTT125_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_EG25er_HTT125"], &b_L1_EG25er_HTT125_Prescl);
  ...
  fChain->SetBranchAddress("L1_ETT15_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_ETT15"], &b_L1_ETT15_Prescl);
  fChain->SetBranchAddress("L1_SingleMu30er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleMu30er"], &b_L1_SingleMu30er_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleTauJet36er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleTauJet36er"], &b_L1_DoubleTauJet36er_Prescl);
  fChain->SetBranchAddress("L1_SingleJet36_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleJet36"], &b_L1_SingleJet36_Prescl);
  fChain->SetBranchAddress("L1_SingleJet200_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleJet200"], &b_L1_SingleJet200_Prescl);
  fChain->SetBranchAddress("L1_SingleJet176_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_SingleJet176"], &b_L1_SingleJet176_Prescl);
  ...
  fChain->SetBranchAddress("L1_DoubleJetC120_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC120"], &b_L1_DoubleJetC120_Prescl);
  fChain->SetBranchAddress("L1_DoubleJetC72_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleJetC72"], &b_L1_DoubleJetC72_Prescl);
  fChain->SetBranchAddress("L1_QuadJetC84_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_QuadJetC84"], &b_L1_QuadJetC84_Prescl);
  fChain->SetBranchAddress("L1_Mu16er_TauJet20er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu16er_TauJet20er"], &b_L1_Mu16er_TauJet20er_Prescl);
  fChain->SetBranchAddress("L1_IsoEG20er_TauJet20er_NotWdEta0_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_IsoEG20er_TauJet20er_NotWdEta0"], &b_L1_IsoEG20er_TauJet20er_NotWdEta0_Prescl);
  fChain->SetBranchAddress("L1_DoubleTauJet40er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_DoubleTauJet40er"], &b_L1_DoubleTauJet40er_Prescl);
  fChain->SetBranchAddress("L1_Mu5_EG15_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu5_EG15"], &b_L1_Mu5_EG15_Prescl);
  fChain->SetBranchAddress("L1_Mu12_EG10_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu12_EG10"], &b_L1_Mu12_EG10_Prescl);
  fChain->SetBranchAddress("L1_Mu16er_TauJet40erORCenJet72er_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_Mu16er_TauJet40erORCenJet72er"], &b_L1_Mu16er_TauJet40erORCenJet72er_Prescl);
  fChain->SetBranchAddress("L1_MinimumBiasHF2_OR_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_MinimumBiasHF2_OR"], &b_L1_MinimumBiasHF2_OR_Prescl);
  fChain->SetBranchAddress("L1_MinimumBiasHF2_AND_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_MinimumBiasHF2_AND"], &b_L1_MinimumBiasHF2_AND_Prescl);
  fChain->SetBranchAddress("L1_MinimumBiasHF1_OR_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_MinimumBiasHF1_OR"], &b_L1_MinimumBiasHF1_OR_Prescl);
  fChain->SetBranchAddress("L1_MinimumBiasHF1_AND_v1_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_MinimumBiasHF1_AND_v1"], &b_L1_MinimumBiasHF1_AND_v1_Prescl);
  ...
  fChain->SetBranchAddress("L1_AlwaysTrue_Prescl", &map_RefPrescaleOfStandardHLTPath["L1_AlwaysTrue"], &b_L1_AlwaysTrue_Prescl);
